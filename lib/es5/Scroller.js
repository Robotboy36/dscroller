...
var members = {
  ...
  scrollTo: function (left, top, animate, zoom, callback) {
    ...
    // 允许误差 <0.1
    if (left === self.__scrollLeft && (top === self.__scrollTop || Math.abs(top - self.__scrollTop) < 0.1)) {
      animate = false;
      if (callback) {
        callback();
      }
      ...
      if (self.__enableScrollX) {
        ...
        if (scrollLeft > maxScrollLeft || scrollLeft < 0) {
          ...
          if (self.options.bouncing) {
            ...
            scrollLeft += (moveX / 4 * this.options.speedMultiplier);
      ...
      if (self.__enableScrollY) {
        ...
        if (scrollTop > maxScrollTop || scrollTop < 0) {
          ...
          if (self.options.bouncing) {
            ...
            scrollTop += (moveY / 4 * this.options.speedMultiplier);
